<div class="container mt-4">
    ...
    <p><?php echo __('assign_technicians_to_tickets'); ?></p>

    <?php if (isset($_GET['status'])): ?>
        <?php if ($_GET['status'] === 'assign_success'): ?>
            <div class="alert alert-success"><?php echo __('technician_assigned_successfully'); ?></div>
        <?php elseif ($_GET['status'] === 'assign_error'): ?>
            <div class="alert alert-danger"><?php echo __('technician_assign_error'); ?></div>
        <?php endif; ?>
    <?php endif; ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <span class="badge bg-secondary"><?php echo __('not_assigned'); ?></span>
                        <?php endif; ?>
                    </td>
                    <td>
                        ...
                        <button type="button" class="btn btn-sm btn-info" onclick="abrirChat(<?php echo $ticket['id_ticket']; ?>, 'tecnico')" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo __('chat_with_technician'); ?>">
                            <i class="fas fa-headset"></i>
                        </button>
                        <?php endif; ?>
                         <a href="index.php?accion=verHistorial&id_ticket=<?php echo $ticket['id_ticket']; ?>" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo __('view_history'); ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="asignarTecnicoModalLabel"><?php echo __('assign_technician_to_ticket'); ?> #<span id="modal-ticket-id"></span></h5>
