                    ...
                    <?php if (isset($_SESSION['usuario'])): ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0">
                            ...
                            <?php if (isset($_SESSION['rol']) && $_SESSION['rol'] == 1):?>
                                ...
                                <li><a class="dropdown-item" href="index.php?accion=mostrarPiezas"><i class="fas fa-cog me-2"></i>Ajustes de piezas</a></li>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['rol']) && $_SESSION['rol'] == 2):?>
                                <li><a class="dropdown-item" href="index.php?accion=misTickets"><i class="fas fa-ticket-alt me-2"></i>Mis Tickets</a></li>
                                <li><a class="dropdown-item" href="index.php?accion=mostrarPiezas"><i class="fas fa-cogs me-2"></i>Piezas</a></li>
