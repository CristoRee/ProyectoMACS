<div class="container mt-4">
    ...
    <form action="index.php?accion=editarPieza&id=<?php echo $pieza['id_repuesto']; ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" required value="<?php echo htmlspecialchars($pieza['nombre']); ?>" placeholder="Ej: Tornillo M5">
        </div>
        <div class="mb-3">
            <label for="descripcion" class="form-label">Descripción</label>
            <textarea class="form-control" id="descripcion" name="descripcion" rows="3" placeholder="Descripción opcional de la pieza"><?php echo htmlspecialchars($pieza['descripcion']); ?></textarea>
        </div>
        <div class="mb-3">
